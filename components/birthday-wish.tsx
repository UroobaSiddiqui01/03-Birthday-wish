  ...
  return (
    ...
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-4">
      ...
      {showCard && (
        ...
        >
          {/* Birthday card with background color */}
          <Card
            style={{ backgroundColor: 'violet' }} // Set the card background color here
          ...
          >
            ...
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-2xl font-semibold text-gray-600">Urooba Siddiqui</CardDescription>
              <p className="text-lg text-gray-500">November 13th</p>
            </CardHeader>
